...
namespace :doc do
  Rake::RDocTask.new do |rdoc|
    rdoc.rdoc_dir = 'doc'
    rdoc.title    = "AWS2::S3 -- Support for Amazon S3's REST api"
...
namespace :dist do
  spec = Gem::Specification.new do |s|
    s.name              = 'aws-s3'
    s.version           = Gem::Version.new(AWS2::S3::Version)
    ...
    s.rdoc_options  = ['--title', "AWS2::S3 -- Support for Amazon S3's REST api",
                       '--main',  'README',

module AWS2
  module S3
    ...
    #
    #   Service.buckets
    #   # => [#<AWS2::S3::Bucket @attributes={"name"=>"jukebox"}>]
    #
    ...
    #   # => [#<AWS2::S3::S3Object '/jukebox/black-flowers.mp3'>]
    #
    ...
    class Bucket < Base
      class << self
        ...
        #     # => [<AWS2::S3::S3Object '/jazz/miles.mp3'>, <AWS2::S3::S3Object '/jazz/dolphy.mp3'>, <AWS2::S3::S3Object '/classical/malher.mp3'>]
        #     Bucket.objects('jukebox', :prefix => 'classical')
        #     # => [<AWS2::S3::S3Object '/classical/malher.mp3'>]
        #
        ...
        #     # => [<AWS2::S3::S3Object '/jazz/miles.mp3'>]
        #
        # === Examples
        #
        ...
        #   # => [<AWS2::S3::S3Object '/jazz/miles.mp3'>, <AWS2::S3::S3Object '/classical/malher.mp3'>]
        #
        ...
        # List all your buckets. This is a convenient wrapper around AWS2::S3::Service.buckets.
      ...
      #
      #   bucket.objects
      #   => [#<AWS2::S3::S3Object '/marcel_molina/beluga_baby.jpg'>,
      #       #<AWS2::S3::S3Object '/marcel_molina/tongue_overload.jpg'>]

module AWS2
  module S3
    ...
    #   pp policy.grants
    #   [#<AWS2::S3::ACL::Grant FULL_CONTROL to noradio>,
    #    #<AWS2::S3::ACL::Grant READ to AllUsers Group>]
    #
    ...
    #
    #   grant = ACL::Grant.new
    #   # => #<AWS2::S3::ACL::Grant (permission) to (grantee)>
    ...
    #   # => #<AWS2::S3::ACL::Grantee (xsi not set yet)>
    #
    ...
    #   grant
    #   # => #<AWS2::S3::ACL::Grant READ_ACP to AllUsers Group>
    #
    ...
    module ACL
      ...
      #   grant
      #   => #<AWS2::S3::ACL::Grant READ to (grantee)>
      #

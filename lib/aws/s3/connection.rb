    ...
    class Connection #:nodoc:
      ...
      private
        ...
        def add_user_agent!(request)
          request['User-Agent'] ||= "AWS2::S3/#{Version}"
        end
      ...
      module Management #:nodoc:
        ...
        # Manage the creation and destruction of connections for AWS2::S3::Base and its subclasses. Connections are
        ...
        module ClassMethods
          ...
          #
          # You can set connections for every subclass of AWS2::S3::Base. Once the initial connection is made on
          ...
          # option.
          #
          #   AWS2::S3::Bucket.established_connection!(:use_ssl => true)
          #
          ...
          #
          #   AWS2::S3::Bucket.established_connection!(:proxy => {

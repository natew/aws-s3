module AWS2
  module S3
    # Anything you do that makes a request to S3 could result in an error. If it does, the AWS2::S3 library will raise an exception
    ...
    #
    #   error
    #   # => #<AWS2::S3::BucketNotEmpty The bucket you tried to delete is not empty>
    #   error.message
